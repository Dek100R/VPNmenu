...
2. Для белого списка Happ:
   - Открой главный пункт «Обновить белый список Happ».
...
main_menu() {
  ...
  while true; do
    show_header
    echo -e "${C_GRAY}Главное меню: WARP/x-ui, белые списки Happ, Telegram, автоматизация, диагностика и обслуживание.${C_RESET}"
    echo
    ...
    menu_line "7" "✅" "$C_GREEN" "Обновить белый список Happ"
